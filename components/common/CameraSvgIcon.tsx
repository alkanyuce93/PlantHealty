...
import Svg, { Circle, Path, Defs, LinearGradient, Stop, Filter, FeFlood, FeBlend, FeColorMatrix, FeMorphology, FeOffset, FeGaussianBlur, FeComposite } from 'react-native-svg';
...
const CameraSvgIcon: React.FC<CameraSvgIconProps> = ({ 
  ...
  return (
    <View style={[styles.cameraButton, { width: size, height: size * 0.86 }]}>
      <Svg width={size} height={size * 0.86} viewBox="0 0 74 64" fill="none">
        <Defs>
          <Filter id="filter0_i_3_7281" x="4" y="0" width="64" height="64" filterUnits="userSpaceOnUse">
        ...
        {/* Background circle with gradient and filter */}
        <Circle cx="36" cy="32" r="32" fill="url(#paint0_linear_3_7281)" filter="url(#filter0_i_3_7281)"/>
        
        {/* White border circle */}
        <Circle cx="36" cy="32" r="30" stroke="white" strokeOpacity="0.24" strokeWidth="4"/>
